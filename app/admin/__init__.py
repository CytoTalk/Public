...
from app.views.admin.ImageView import (ImageUpdate,ImageIndex,ImagePost,ImageCreate,ImageDelete,ImageEdit,ImageShow)
...
# Category Routes
admin.add_url_rule('/project/<project_id>/category/', view_func=CategoryIndex.as_view('category_index'), methods=['GET'])
...
admin.add_url_rule('/project/category/<category_id>/delete', view_func=ProjectDelete.as_view('category_delete'), methods=['POST'])

# Image Routes
admin.add_url_rule('/<category_id>/category/', view_func=ImageIndex.as_view('image_index'), methods=['GET'])
...
admin.add_url_rule('/category/<image_id>/edit', view_func=ImageEdit.as_view('image_edit'), methods=['GET'])
admin.add_url_rule('/category/<image_id>/edit', view_func=ImageUpdate.as_view('image_update'), methods=['POST'])
admin.add_url_rule('/category/<image_id>/delete', view_func=ProjectDelete.as_view('image_delete'), methods=['POST'])
